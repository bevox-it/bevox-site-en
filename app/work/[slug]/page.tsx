...
export default async function Page({params}:{params:Promise<{slug:string}>}){const p=findPage(workPages,(await params).slug);if(!p)notFound();return <WorkPage page={p}/>}
