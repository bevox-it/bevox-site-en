...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    const pages = ['business-evolution','services','solutions','industries','work','evolution-hub','process','process-map','roi-calculator','about','locations','contact','privacy','terms','thank-you'];
    return [
      ...pages.flatMap(path => ([
